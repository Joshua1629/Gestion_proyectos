...
import { type Proyecto, type Fase, getProyecto, updateFase } from '../services/proyectos';
import { type Tarea, getTareasByProyecto, getUsuarios } from '../services/tareas';
        ...
        <div className="proyecto-metadata">
          <div className="metadata-item">
            ...
            <span className="metadata-value">
              {proyecto.fecha_inicio ? formatDate(proyecto.fecha_inicio) : 'No definida'}
            </span>
          </div>
          <div className="metadata-item">
              ...
              <div className="progress-circle">
                <svg width="120" height="120" className="progress-ring">
                  ...
                  <circle
                    ...
                    cy="60"
                    r="50"
                    strokeDasharray={`${(proyecto.progreso_general || 0) * 3.14159} 314.159`}
                  />
                </svg>
                <div className="progress-text">{proyecto.progreso_general || 0}%</div>
              </div>
              <div className="progress-details">
                <p>Progreso del proyecto basado en las tareas completadas y el avance de las fases.</p>
              </div>
            </div>
            ...
            <div className="quick-stats">
              ...
              <div className="stats-list">
                <div className="stats-item">
                  ...
                  <span className="stats-item-value">{proyecto.fases?.length || 0}</span>
                </div>
                <div className="stats-item">
                  <span className="stats-item-label">Fases Completadas</span>
                  <span className="stats-item-value">
                    {proyecto.fases?.filter(f => f.estado === 'Completado').length || 0}
                  </span>
                </div>
                <div className="stats-item">
                  <span className="stats-item-label">Total de Tareas</span>
                  <span className="stats-item-value">{tareas.length}</span>
                </div>
                <div className="stats-item">
                ...
                <div className="stats-item">
                  ...
                  <span className="stats-item-value">
                    {tareas.filter(t => t.progreso > 0 && t.progreso < 100).length}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="fases-list">
            {proyecto.fases && proyecto.fases.length > 0 ? (
                ...
                <div key={fase.id} className="fase-card">
                  <div className="fase-header">
                    ...
                    <select 
                      ...
                      value={fase.estado}
                      onChange={(e) => handleUpdateFase(fase.id, e.target.value as Fase['estado'])}
                    >
                  ...
                  <div className="fase-progress">
                    <div className="progress-header">
                      ...
                      <span className="progress-percentage">{getProgresoFase(fase.nombre)}%</span>
                    </div>
              ...
              <div className="empty-state">
                ...
                <p className="empty-description">Este proyecto aún no tiene fases configuradas.</p>
              </div>
            )}
          </div>
        )}
            ...
            <div className="tareas-list">
              {tareas.length > 0 ? (
                ...
                <div className="empty-state">
                  ...
                  <p className="empty-description">Este proyecto aún no tiene tareas asignadas.</p>
                </div>
              )}
            </div>
          </div>
